...
public class RobotContainer {
  ...
  private final driveSubsys driveSub = new driveSubsys();
  
  private final Joystick DriverContr = new Joystick(Constants.driverPort);
  private final Joystick Operator = new Joystick(Constants.operatorPort);
